...
namespace ScrumTable
{
    public partial class frmMain : Form
    {
        ...
        {
            InitializeComponent();
            SQLHelper.SQLStart("Data Source=DESKTOP-GE1HC9J;Initial Catalog=ScrumTableDB; Integrated Security=True");
        }
